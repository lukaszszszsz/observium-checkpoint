...
print_warning("This page is broken for now, will be fixed soon.");
...
if($vserver['serverstate'] == "inService") { $vserver_class="label label-success"; } else { $vserver_class="label label-error"; }
