...
// FIXME, FIX ME, yes I said fix me! Need complete rewrite this graphs to entities style
// This page broken for now

print_warning("This page broken for now, will fixed soon.");
...
$i = "0";
foreach (dbFetchRows("SELECT * FROM `loadbalancer_rservers` WHERE `device_id` = ? ORDER BY `rserver_index`", array($device['device_id'])) as $rserver)
{
